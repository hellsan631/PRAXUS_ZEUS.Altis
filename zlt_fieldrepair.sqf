...
#define DEFAULT_FIELDREPAIR_EACH_PART_TIME 8
#define DEFAULT_FIELDREPAIR_EACH_HARDPART_TIME 16
#define DEFAULT_FULLREPAIR_LENGTH 30
#define DEFAULT_REPAIR_TRUCK_USES 5
#define DEFAULT_FREE_REPAIRS 2
